    ...
    <footer class="text-center text-white" style="background-color: #3e4551">
        ...
        <div class="p-4 pb-0">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 mb-4 mb-md-0 ">
                        <ul class="list-unstyled mb-0 ">
                            <li>
                                <h5>Adres</h5>
                                <p class="text-white">Çukurova Üniversitesi</p>
                            </li>
                            <li>
                                <h5>İletişim</h5>
            ...
            <div class="mb-4 mt-4 text-center">
                ...
                <!-- Twitter -->
                <a class="btn btn-outline-light btn-floating m-1" href="https://twitter.com/?lang=tr" role="button"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-twitter" viewBox="0 0 16 16">
                ...
                <!-- Youtube -->
                <a class="btn btn-outline-light btn-floating m-1" href="https://www.youtube.com/" role="button"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-youtube" viewBox="0 0 16 16">
                ...
                <!-- Facebook -->
                <a class="btn btn-outline-light btn-floating m-1" href="https://tr-tr.facebook.com/" role="button"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
